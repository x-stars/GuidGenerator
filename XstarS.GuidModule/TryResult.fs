...
module internal TryResult =
    ...
    /// <param name="out">The output value of the try-operation.</param>
    ...
    /// </summary>
    /// <param name="ret">The value indicates whether the try-operation was successful.</param>
    /// <param name="out1">The first output value of the try-operation.</param>
    /// <param name="out2">The second output value of the try-operation.</param>
    /// <returns>An <see cref="T:Microsoft.FSharp.Core.option`1"/> of the try-operation result.</returns>
