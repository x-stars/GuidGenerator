...
app.MapGet("/", (int? count) => HandleCount(GuidGenerator.Version4, count));

app.MapGet("/v1", (int? count) => HandleCount(GuidGenerator.Version1, count));
app.MapGet("/v1r", (int? count) => HandleCount(GuidGenerator.Version1R, count));
...
app.MapGet("/v4", (int? count) => HandleCount(GuidGenerator.Version4, count));
...
app.MapGet("/v6", (int? count) => HandleCount(GuidGenerator.Version6, count));
app.MapGet("/v6p", (int? count) => HandleCount(GuidGenerator.Version6P, count));
app.MapGet("/v6r", (int? count) => HandleCount(GuidGenerator.Version6R, count));

app.MapGet("/v7", (int? count) => HandleCount(GuidGenerator.Version7, count));

app.MapGet("/v8", (int? count) => HandleCount(GuidGenerator.Version8, count));
...
static object HandleCount(IGuidGenerator guidGen, int? count) => (count is null) ?
